    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          description: 'Upload copy of each certificate listed above',
          required: true,
          showWhen: {
            field: 'hasBoardCertificate',
            equals: 'Yes',
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          description: 'If any of the three health questions above are answered Yes, documentation with the release/clearance date is required.',
          required: false,
          showWhen: {
            field: 'isClinicalStaff',
            equals: 'Yes',
